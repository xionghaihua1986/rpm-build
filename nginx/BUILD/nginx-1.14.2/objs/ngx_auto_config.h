#define NGX_CONFIGURE " --prefix=/opt/websuite/nginx --pid-path=/opt/run/nginx/nginx.pid --error-log-path=/opt/log/nginx/error.log --user=nginx --group=nginx --with-stream --with-file-aio --with-http_ssl_module --with-http_flv_module --with-http_v2_module --with-http_flv_module --with-http_mp4_module --with-http_stub_status_module --with-http_gzip_static_module --conf-path=/opt/config/nginx/conf/nginx.conf --with-pcre"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/opt/websuite/nginx/"
#endif


#ifndef NGX_CONF_PREFIX
#define NGX_CONF_PREFIX  "/opt/config/nginx/conf/"
#endif
...
#define NGX_CONF_PATH  "/opt/config/nginx/conf/nginx.conf"
#endif


#ifndef NGX_PID_PATH
#define NGX_PID_PATH  "/opt/run/nginx/nginx.pid"
#endif
...
#define NGX_ERROR_LOG_PATH  "/opt/log/nginx/error.log"
#endif
